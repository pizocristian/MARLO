...
public class ProjectCenterListAction extends BaseAction {

  /**
   * 
   */
  private static final long serialVersionUID = 4904409449546064551L;

  private final Logger logger = LoggerFactory.getLogger(ProjectCenterListAction.class);
  ...
  @Inject
  public ProjectCenterListAction(APConfig config, ProjectManager projectManager, GlobalUnitManager crpManager,
