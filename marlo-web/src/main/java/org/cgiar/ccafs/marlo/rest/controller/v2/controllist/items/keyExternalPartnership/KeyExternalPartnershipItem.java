...
public class KeyExternalPartnershipItem<T> {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(KeyExternalPartnershipItem.class);
    ...
    public KeyExternalPartnershipItem(GlobalUnitManager globalUnitManager, PhaseManager phaseManager,
            ...
            KeyExternalPartnershipMapper keyExternalPartnershipMapper, RestApiAuditlogManager restApiAuditlogManager) {
        super();
            ...
            if (fieldErrors.isEmpty()) {
                ...
                if (keyPartnershipExternalDB != null) {
                    ...
                    try {
                        ...
                        RestApiAuditlog restApiAuditLog = new RestApiAuditlog("createKeyExternalPartnership", "Created CGIAR Entity Acronym " + CGIARentityAcronym + " ID " + keyExternalPartnershipID, new Date(), keyExternalPartnershipID, "class org.cgiar.ccafs.marlo.data.model.ReportSynthesisKeyPartnershipExternal",
     ...
     * @param year
     * @param phase
     * @return a KeyExternalPartnershipDTO with the Key External Partnership
     * Item
     */
     ...
     *
     * @param idKeyExternalPartnership
     * @param newKeyExternalPartnershipDTO
     * @param CGIARentityAcronym
     * @param user
