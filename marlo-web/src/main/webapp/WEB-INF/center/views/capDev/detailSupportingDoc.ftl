...
[#assign pageLibs = ["datatables.net", "datatables.net-bs4", "select2", "flag-icon-css", "pickadate"] /]
[#assign customCSS = [
      ...
      <div  class="fullForm borderBox" >
        ...
        <div class="form-group row datePickersBlock">  
          ...
          <div class="col-md-3">
            ...
            [@customForm.select name="deliverable.year"  listName="allYears" help="" i18nkey="Delivery Year" className="" placeholder="capdev.select" required=true editable=editable /]
          </div>
        </div>
