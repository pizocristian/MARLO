...
/]
[#assign pageLibs = ["datatables.net", "datatables.net-bs4","select2","flag-icon-css"] /]
    ...
    <div class="col-md-9 ">
      ...
      <div class="col-md-12">
        <div class="float-right">
          ...
          [#else]
            <a class="" href="[@s.url action='${centerSession}/capdev' /] "><span class="fas fa-arrow-alt-circle-left"></span>[@s.text name="capdev.gotoBack" /]</a>
          [/#if]
        </div>
      </div>
