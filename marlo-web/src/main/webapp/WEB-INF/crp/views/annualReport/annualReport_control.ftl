      ...
      <div class="col-md-9">
        ...
        [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
          ...
          <div class="borderBox">
            ...
            <small class="float-right"><a href="${guideSheetURL}" target="_blank"> <img src="${baseUrlCdn}/global/images/icon-file.png" alt="" /> #C2 Partnerships - Guideline </a> </small>
          ...
          <div class="borderBox">
            ...
            <small class="float-right"><a href="${guideSheetURL}" target="_blank"> <img src="${baseUrlCdn}/global/images/icon-file.png" alt="" /> #C3 Participants + #C4 Trainees - Guideline </a> </small>
          ...
          <div class="borderBox">
            ...
            <small class="float-right"><a href="${guideSheetURL}" target="_blank"> <img src="${baseUrlCdn}/global/images/icon-file.png" alt="" /> #C5 Peer review papers - Guideline </a> </small>
      ...
      [#list list as item]
        ...
        <tr>
          ...
          <td class="text-center">
            ...
            <img src="${baseUrlCdn}/global/images/openAccess-${(item.deliverable.dissemination.isOpenAccess?string)!'false'}.png" alt="" />
          </td>
          [#-- Journal ISI --]
          <td class="text-center">
            <span style="display:none">${(item.deliverable.publication.isiPublication?string)!'false'}</span>
            <img src="${baseUrlCdn}/global/images/checked-${(item.deliverable.publication.isiPublication?string)!'false'}.png" alt="" />
          </td>
        </tr>
      [/#list]
    [#else]
