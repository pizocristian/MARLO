...
[#assign pageLibs = [ "datatables.net", "datatables.net-bs4", "components-font-awesome" ] /]
[#assign customJS = [ 
      ...
      <div class="col-md-9">
        ...
        [@s.form action=actionName method="POST" enctype="multipart/form-data" cssClass=""]
          ...
          <div class="borderBox">
            ...
            <small class="float-right"><a href="${guideSheetURL}" target="_blank"> <img src="${baseUrlCdn}/global/images/icon-file.png" alt="" /> #I3 Policies - Guideline </a> </small>
