...
[#macro tableFPSynthesis tableName="tableName" list=[] columns=[] crpProgramField="reportSynthesis.liaisonInstitution.crpProgram" showEmptyRows=true showTitle=true showHeader=true allInOne=false urlify=true]
  <div class="form-group">
    ...
    <table class="table table-bordered">
      ...
      <thead>
        <tr>
          <th class="text-center"> [@s.text name="annualReport2018.tableFP" /] </th>
          [#if allInOne]
                ...
                <tbody>
                  [#list list as item]
                    ...
                    <tr>
                      ...
                      <td class=""> [@utils.tableList list=(item.srfTargets)![] displayFieldName="srfSloIndicator.title" /] </td>
                      ...
                      <td> <a href="${url}" target="_blank"><span class="fas fa-external-link-alt"></span></a>  </td>
                    </tr>
                  [/#list]
                </tbody>
              </table>
