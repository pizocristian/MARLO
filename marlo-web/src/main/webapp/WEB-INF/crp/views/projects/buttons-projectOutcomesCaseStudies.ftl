...
<div class="buttons">
  <div class="buttons-content">
    ...
    [#if editable]
      [#-- Back Button 
      <a href="[@s.url][@s.param name="projectOutcomeID" value=projectOutcomeID /][/@s.url]" class="form-button button-edit"><span class="far fa-eye" aria-hidden="true"></span> [@s.text name="form.buttons.back" /]</a>
      --]
      [#-- Discard Button 
