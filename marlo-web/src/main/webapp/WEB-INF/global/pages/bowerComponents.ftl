...
[#macro css_imports libraryName]
  ...
  [#if libraryName="bootstrap" ]<link rel="stylesheet" href="${baseUrlCdn}/global/bower_components/bootstrap/dist/css/bootstrap.min.css?20202606" />[/#if]
  ...
  [#if libraryName="datatables.net-bs4" ]<link rel="stylesheet" href="${baseUrlCdn}/global/bower_components/datatables.net-bs4/css/dataTables.bootstrap4.css" />[/#if]
...
[#macro js_imports libraryName]
  ...
  [#if libraryName="datatablesjs"]<script src="${baseUrlCdn}/global/bower_components/datatables/media/js/jquery.dataTables.js"></script>[/#if]
  ...
  [#if libraryName="datatables.net-bs4"]<script src="${baseUrlCdn}/global/bower_components/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>[/#if]
