...
[#assign customJS = ["${baseUrlCdn}/global/js/legalInformation.js"] /]
[#assign customCSS = ["${baseUrlCdn}/global/css/legalInformation.css"] /]
...
<section class="container contentForm">
  <div class="fullContent">
    <div class="col-md-offset-1 col-md-10">
      ...
      <h3 id="privacyNotice">Privacy Policy</h3>
      <div class="simpleBox">
        ...
        <p>Through your interactions with our site, we may also collect, have access to, store and use your computer&rsquo;s IP address, the URL/domain name of any referring website, the time and date of your visit to the site.</p>
        ...
        <p>We collect information from you when you register, login in to make a purchase, respond to a form, surf the website, or use certain other site features. We may use such information in the following ways:</p>
        <ul>
        ...
        <p>Google, as a third-party vendor, uses cookies to track statistics on our site. More information can be found in: <a href="https://www.google.com/intl/en/policies/privacy/">https://www.google.com/intl/en/policies/privacy/</a></p>
        ...
        <p><strong>Your entitlements as Data Subject </strong></p>
         
        <p>Data Subject is the natural person whose personal data is collected and/or processed. As such, you can, at any time: access your Personal Data to know the details of treatment of them, update them, rectify them in the event of being inaccurate, incorrect or outdated, and cancel or delete it when it is considered not required for any of the purposes indicated in this privacy policy, or are being used for purposes not consented.</p>
        <p>If you need access to your Personal Data, send an application to <a href="mailto:MARLOSupport@cgiar.org">MARLOSupport@cgiar.org</a> , or to the physical address stated below. The MARLO team will attend your claim within fifteen (15) working days from the day after the day of receipt. If during this period, we request from you more information to execute your wish and no response is received after one (1) month, the claim will be deemed withdrawn. The request for deletion of the information and the revocation of the authorization will not proceed when the Data Subject has a legal or contractual duty to remain in the database.</p>
         
        <p>Except in countries or jurisdictions where it is not permitted by law, we may from time to time send you email communications regarding our products or services in response to your use of the site. By providing your email address, you consent to receive such communications. <strong>If at any time you would like to unsubscribe from receiving future emails, you can email us at </strong><a href="mailto:MARLOSupport@cgiar.org">MARLOSupport@cgiar.org</a> and we will promptly remove you from&nbsp;<strong>ALL</strong>&nbsp;correspondence.</p>
        ...
        <p>Palmira, Valle del Cauca 763537</p>
        <p>Colombia</p>
      ...
      <div class="simpleBox">
        ...
        <ol start="9">
          <li><strong>Governing Law</strong>
            ...
            <p>In the case an amicable settlement is not reached within sixty (60) days of such dispute, controversy or claim having been notified by one party to the other in writing, the dispute, controversy or claim will be settled by arbitration in accordance with the UNCITRAL Arbitration Rules in effect on the date of this contract. There will be one arbitrator appointed by the parties by mutual consent, or failing this, by the Secretary-General of the Permanent Court of Arbitration. The place of arbitration will be [insert city and country], and the language to be used in the arbitration proceedings will be English.</p>
          </li>
        </ol>
      </div>
