...
[#assign pageLibs = [ "flag-icon-css", "google-diff-match-patch", "jquery-pretty-text-diff", "datatables.net", "datatables.net-bs4"] /]
[#assign customJS = [ 
  "${baseUrlCdn}/global/js/superadmin/marloInstitutions.js?20181122" 
  ] 
/]
[#assign customCSS = [ 
