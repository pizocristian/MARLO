  ...
  <div class="container"> 
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        [#-- Add Outcome Button --]
        <div class="addSlo bigAddButton text-center"><span class="fas fa-plus" aria-hidden="true"></span> [@s.text name="form.buttons.addSlo"/]</div>
    ...
    <div class="blockContent" style="display:none">
      ...
      <div class="srfIndicators ">
        ...
        <div class="text-right">
          <div class="addIndicator button-blue"><span class="fas fa-plus-circle" aria-hidden="true"></span> [@s.text name="form.buttons.addIndicator"/]</div>
        </div>
      </div>
...
[#macro srfSloIndicator element name index isTemplate=false]
  <div id="srfSloIndicator-${isTemplate?string('template',index)}" class="srfSloIndicator grayBlock form-group" style="position:relative;display:${isTemplate?string('none','block')}">
    ...
    <div class="text-right">
      <div class="addTargets button-green"><span class="fas fa-plus-circle" aria-hidden="true"></span> Add a target</div>
    </div>
    <div class="clearfix"></div>
...
[#macro targetIndicator element name index isTemplate=false]
  <div id="targetIndicator-${isTemplate?string('template',index)}" class="targetsIndicator" style="position:relative;display:${isTemplate?string('none','block')}">
      <div class="targetsContent">
        ...
        <span class="targetRemove remove-element fas fa-times red"></span>
      </div>      
    <div class="clearfix"></div>
  </div>
[/#macro]
